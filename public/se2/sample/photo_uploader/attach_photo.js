    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/se2/sample/photo_uploader/file_uploader_html5.php'; 	//upload URL
		
		
    	//sUploadURL= '/bbs/review/upload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/se2/sample/photo_uploader/file_uploader.php',	//샘플 URL입니다.
			//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/bbs/review/upload',	//샘플 URL입니다.
