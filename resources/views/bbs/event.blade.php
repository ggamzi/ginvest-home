...
<div class="cont">
	<div class="sb5 sb">
		<div class="sb_title_box">
			<h6 class="sb_title">EVENT</h6>
			<span>갤럭시투자그룹의 이벤트를 한 눈에 확인하세요.</span>
		</div>
		<div class="sc1">
								...
								<dl class="clr">
									<dt>								
										@if($row->thumbnail != null || $row->thumbnail != '')
											<img src="/event/{{ $row->thumbnail }}">
										@endif
									</dt>
									<dd>          
										<div>
											<a href="/bbs/event/{{ $row->id }}/info">
												<p class="press_txt01">{{ $row->title }}</p>
											</a>
											<span class="press_txt02"></span>
											<span class="press_txt02"></span>
											<span class="press_txt02 link_ad"></span>
